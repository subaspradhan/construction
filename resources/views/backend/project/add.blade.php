        ...
        <form action="/project-store" method="POST" enctype="multipart/form-data">
            ...
            <div class="row gy-3">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    ...
                    <input type="text" name="cname" class="form-control" placeholder="Enter Client Name" required>
                </div>
                <div class="col-12 col-sm-6 col-md-6">
                    <label class="form-label">Architech Name</label>
                    <input type="text" name="aname" class="form-control" placeholder="Enter Architech Name" required>
                </div>
                <div class="col-12 col-sm-6 col-md-6">
                    <label class="form-label">Builder Name</label>
                    <input type="text" name="bname" class="form-control" placeholder="Enter Builder Name" required>
                </div>
                <div class="col-12 col-sm-6 col-md-6">
