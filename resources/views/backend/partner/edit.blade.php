...
<div class="row gy-4">
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('partner.admin.update',$partner->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row gy-3">
                ...
                <div class="col-12 col-sm-12 col-md-12">  
                    <label>Details</label>
                    <textarea id="summernote" name="details">{{ old('details', $partner->details ?? '') }}</textarea>
                </div>
                <div class="col-12 col-sm-6 col-md-6">
                    <label for="banner_image" class="form-label">Partner Image</label>
                    <div class="input-group">
                        <input type="file" name="image" id="banner_image" class="form-control" accept="image/*" value="{{$partner->image}}">
                    </div>
                </div>
