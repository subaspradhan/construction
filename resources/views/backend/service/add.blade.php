            ...
            <div class="row gy-3">
                ...
                <div class="col-12 col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="file" name="image" id="media_upload" class="form-control" accept="image/*" required>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-12">  
                    ...
                    <textarea id="summernote1" name="pcondetails">{{ old('pcondetails', $yourModel->pcondetails ?? '') }}</textarea>
                </div>
                <div class="col-12 col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="file" name="pconimage" id="media_upload" class="form-control" accept="image/*" required>
                    </div>
                    <small class="form-text text-muted">
                        Accepted formats: JPG, PNG, WEBP Max size: 15MB.
                    </small>
                ...
                <div class="col-12 col-sm-12 col-md-12">  
                    ...
                    <textarea id="summernote2" name="postcondetails">{{ old('postcondetails', $yourModel->postcondetails ?? '') }}</textarea>
                </div>
                 <div class="col-12 col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="file" name="postconimage" id="media_upload" class="form-control" accept="image/*" required>
                    </div>
                    <small class="form-text text-muted">
                        Accepted formats: JPG, PNG, WEBP Max size: 15MB.
                    </small>
