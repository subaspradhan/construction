...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
  <h6 class="fw-semibold mb-0">Gallery From</h6>
</div>
...
<div class="row gy-4">
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('gallery.admin.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row gy-3">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    <label for="banner_image" class="form-label">Gallery Image</label>
                    <div class="input-group">
                        <input type="file" name="image" id="banner_image" class="form-control" accept="image/*" value="{{$gallery->image}}">
                    </div>
                </div>
                <img src="{{ asset('storage/' . $gallery->image) }}"
                alt="galleries Image" style="width: 300px;">
            </div>
