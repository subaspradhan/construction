...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
  <h6 class="fw-semibold mb-0">Testimonial From</h6>
</div>
...
<div class="row gy-4">
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <form action="/testi-store" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row gy-3">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    ...
                    <input type="text" name="designation" class="form-control" placeholder="Enter client designation Name" required>
                </div>
                <div class="col-12 col-sm-6 col-md-6">
