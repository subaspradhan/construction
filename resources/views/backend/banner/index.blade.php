...
<div class="dashboard-main-body">
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Banner Table</h6>
      </div>
      ...
      <div class="card basic-data-table">
        ...
        <div class="table-responsive card-body">
          <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
            ...
            @foreach ($banner as $key => $banners)
              <tr>
                ...
                <td><img src="{{ asset('storage/' . $banners->image) }}"
                alt="Banners Image" style="width: 100px;"></td>
                <td>
                  <a href="{{ route('banner.admin.edit', $banners->id) }}"
          ...
          <div class="mt-5">{{ $banner->links('pagination::bootstrap-5') }}</div>
        </div>
      </div>
    </div>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        deleteButtons.forEach(button => {
          button.addEventListener('click', function () {
            ...
            const deleteUrl = "{{ url('/banner-delete') }}/" + id;
