...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
  <h6 class="fw-semibold mb-0">Banner Edit From</h6>
</div>
...
<div class="row gy-4">
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('banner.admin.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row gy-3">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    ...
                    <div class="input-group">
                        <input type="file" name="image" id="banner_image" class="form-control" value="{{$banner->image}}" accept="image/*">
                    </div>
                </div>
                <img src="{{ asset('storage/' . $banner->image) }}" alt="Banners Image" style="width: 300px;">
            </div>
